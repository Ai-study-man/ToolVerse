                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center gap-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-blue-200 text-sm font-medium">专注于 AI 工具分析和评测，拥有 5 年以上经验</p>
                      </div>
                    </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div id="author" className="mx-8 mb-8 p-8 bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl border border-gray-200">
                  <div className="flex flex-col sm:flex-row items-start gap-6">
                    ...
                    <div className="flex-1">
                      <h4 className="text-2xl font-bold text-gray-900 mb-3">关于 AI工具专家</h4>
                      <p className="text-gray-700 mb-4 leading-relaxed text-lg">专注于 AI 工具分析和评测，拥有 5 年以上经验</p>
                      <div className="flex gap-4">
                        <a
                          href="https://x.com/lijiyun155431"
                          target="_blank"
                          rel="noopener noreferrer"
